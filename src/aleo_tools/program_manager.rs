...
use crate::aleo_tools::{api::AleoAPIClient, encryptor::Encryptor};
...
mod tests {
    ...
    fn test_program_management_methods() {
        ...
        let mut program_manager =
            ProgramManager::<TestnetV0>::new(Some(private_key), None, None, None).unwrap();
    ...
    fn test_import_resolution() {
        ...
        let vm_execute =
            ProgramManager::<TestnetV0>::initialize_vm(&api_client, &top_level_program, true)
                .unwrap();
        let vm_deploy =
            ProgramManager::<TestnetV0>::initialize_vm(&api_client, &top_level_program, false)
                .unwrap();
